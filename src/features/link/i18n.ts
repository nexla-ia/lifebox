...
export const T = {
  en: {
    ...
    aEscolher: 'to choose',
    soDetox: 'Detox / add-ons only',
    soDetoxAjuda: 'Go straight to add-ons, no meals to pick. Final price, no tax, no delivery.',
  ...
  pt: {
    ...
    breakfasts: 'breakfasts',
    aEscolher: 'à escolha',
    soDetox: 'Só Detox / adicionais',
    soDetoxAjuda:
      'Vai direto para os adicionais, sem escolher pratos. Preço final, sem tax e sem delivery.',
